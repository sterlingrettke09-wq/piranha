...
const LA_LOCAL: LocalLayer = {
  ...
  notes: [
    // ⚠️ THE CHAPTER 1A QUESTION, CLOSED 2026-08-20. LA runs two zoning codes
    // side by side, so citing only Chapter I was an open risk rather than a
    // settled choice. It is settled now, and it is settled in favour of the
    // existing citation.
    '⚠️ CHAPTER 1A STATES NO ADU STANDARDS, AND EXPRESSLY SENDS YOU BACK HERE. Its Div. 9.5 (Accessory Dwelling Unit Incentive Program) has a heading and ONE sentence of body: "See Chapter I. (General Provisions and Zoning), Sec. 12.22. A.33. (Accessory Dwelling Units (ADU) and Junior Accessory Dwelling Units (JADU)) of this Code for applicable accessory dwelling unit regulations." Established by Ord. 188,418, eff. 2025-01-20, oper. 2025-01-27. So § 12.22 A.33 — the section cited above — governs an ADU on a Chapter 1A lot as well as a Chapter I lot.',
    '⚠️ AND THE DELEGATION IS AUTHORISED BY CHAPTER 1A\u2019S OWN SCOPE RULE, not inferred. § 1.4.2.A.4: Chapter I "does not apply to those areas in which this Zoning Code (Chapter 1A) is applicable, UNLESS EXPRESSLY STATED in this Zoning Code (Chapter 1A)." Div. 9.5 is that express statement. Without it the delegation would not operate, so the two provisions have to be read together.',
    '⚠️ WHAT GEOGRAPHY CHAPTER 1A GOVERNS, stated rather than assumed. § 1.4.2.A.2: "With the exception of Article 13. (Administration), this Zoning Code (Chapter 1A) applies ONLY to projects located on lots with zone designations established in this Zoning Code (Chapter 1A), and does not apply to those lots zoned with districts established in Chapter I." So Chapter 1A reaches only the lots already rezoned into it — it is not a citywide replacement, and the boundary is the Zoning Map rather than a district string this module can read.',
    // ⚠️ THE CROSS-REFERENCE THAT RAISED THE QUESTION IS NOT AN ADU RULE.
    '⚠️ § 13B.10.1.B.2(a) IS THE CITYWIDE VESTED-RIGHTS RULE, NOT AN ADU PROVISION — it grants a vested right once plans sufficient for a complete plan check are accepted and the fee is paid, and it reaches every project. It appears in an ADU context only because § 1.4.2.A.3 makes Article 13 (Administration) applicable to ALL land use in the City, including lots still under Chapter I. ⚠️ "Accessory dwelling" occurs ZERO times in Article 13 (controls: "Sec. 13B" 639, "permit" 246), so the reference carries no ADU standard with it.',
...
export const ADU_VOCABULARY_CHECK: Readonly<Record<string, VocabularyCheck>> = Object.freeze({
  ...
  la: {
    ...
    distinguishedBy:
      '⚠️ THE KITCHEN, stated twice. § 12.03 defines Accessory Living Quarters as "having no kitchen facilities and not rented or otherwise used as a separate dwelling unit", and Guest House as "a dwelling containing not more than five guest rooms or suites of rooms, but with no kitchen facilities". An ADU must include "permanent provisions for living, sleeping, eating, cooking, and sanitation". ⚠️ CHECKED IN BOTH CODES: LA runs Chapter I and Chapter 1A side by side, and a definition in one does not bind the other. Chapter 1A Article 5 (read from the City-hosted PDF, 2,018,320 bytes verified against Content-Length) uses "accessory dwelling unit" — the same noun. ⚠️ THE CHAPTER 1A QUESTION IS NOW CLOSED, AND THE ANSWER IS THAT CHAPTER 1A STATES NO ADU STANDARDS AT ALL. This row previously recorded two things as unestablished — where Chapter 1A\u2019s substantive ADU standards live, and what geography it governs. Both are resolved, from the officially adopted PDFs (Article 9, 1,639,953 bytes; Article 13, 4,524,497 bytes; Article 1, 609,029 bytes; each verified against Content-Length). Div. 9.5 (Accessory Dwelling Unit Incentive Program) is a HEADING WITH ONE SENTENCE OF BODY, quoted in full: "See Chapter I. (General Provisions and Zoning), Sec. 12.22. A.33. (Accessory Dwelling Units (ADU) and Junior Accessory Dwelling Units (JADU)) of this Code for applicable accessory dwelling unit regulations." So Chapter 1A points BACK at the section this module already cites. ⚠️ And the mechanism is stated: § 1.4.2.A.4 provides that Chapter I "does not apply to those areas in which this Zoning Code (Chapter 1A) is applicable, UNLESS EXPRESSLY STATED in this Zoning Code" — Div. 9.5 is that express statement.',
