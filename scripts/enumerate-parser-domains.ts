...
export const TARGETS: Target[] = [
  ...
  // for correctly saying "no limit applies here".
  {
    ...
    partiallyScoped: {
      ...
      label:
        'SPI curated for 2/16/17/20/21 (29 codes); the remaining SPI chapters plus HC-20 / NC / Poncey-Highland / LD deliberately uncurated, plus four codes Part 16 does not establish at all — see zoning/atlanta.ts',
